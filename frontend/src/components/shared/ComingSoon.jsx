...
/**
 * ComingSoon - placeholder component shown for stub pages
 * (login, register, dashboard, admin) until they are implemented.
 */
export default function ComingSoon({ title, description, testId }) {
  const { lang } = useLang();
  const Arrow = lang === "ar" ? ArrowLeft : ArrowRight;
  return (
    <div className="max-w-md w-full text-center" data-testid={testId || "coming-soon"}>
